...
public class FlappyBirdGenome {
    ...
    private final HashMap<Node, Double> inputs = new HashMap<>();
    public Node OutputNode;
    public HashMap<Integer, Node> InputNodes = new HashMap<>();

    /**
     * Initialize a Flappy Bird Genome (Neural Network)
     */
    ...
    /**
     * Creates a new Flappy Bird Genome from a Genome
     * @param genome - Genome
     */
    ...
    /**
     * Inserts the Input Parameters into the Genome
     * @param a - Height Difference from Bird to Top Pipe
     * @param b - Bird Acceleration State
     * @param c - Height Difference from Bird to Bottom Pipe
     * @param d - Distance to next Pipe
     */
    ...
    public double count(Node Start) {
        if (inputs.containsKey(Start)){
            ...
            try {
                ...
                logger.error("Flappy Bird Genome: Stack Overflow Error");
                return 0.0;
            }
        }
    }
