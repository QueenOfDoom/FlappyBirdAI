...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        FlappyBirdGenome original = new FlappyBirdGenome();
        FlappyBirdGenome clonedGenome = new FlappyBirdGenome(original.genome.copy());

        original.genome.mutateConnectionWeights(r);

        clonedGenome.genome.mutateConnectionWeights(r);

        Genome child = Genome.crossoverSameRights(clonedGenome.genome, original.genome, r);
